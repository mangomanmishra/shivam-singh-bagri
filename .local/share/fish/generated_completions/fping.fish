...
complete -c fping -s d -l rdns -d 'Use \\s-1DNS\\s0 to lookup address of return ping packet'
...
complete -c fping -s N -l netdata -d 'Format output for netdata (-l -Q are required).  See: <http://my-netdata'
...
complete -c fping -s Q -l squiet -d 'Like -q, but show summary results every n seconds'
