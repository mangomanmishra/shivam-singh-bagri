...
complete -c inxi -s C -l cpu -d 'Show full CPU output, including per CPU clock speed and CPU max speed (if ava…'
...
complete -c inxi -s F -l full -d 'Show Full output for inxi'
complete -c inxi -s G -l graphics -d 'Show Graphic device(s) information, including details of device and display d…'
...
complete -c inxi -s j -l swap -d 'Shows all active swap types (partition, file, zram)'
complete -c inxi -s J -l usb -d 'Show USB data for attached Hubs and Devices.  Hubs also show number of ports'
complete -c inxi -s l -l label -d 'Show partition labels.  Default: main partitions -P'
...
complete -c inxi -l dmidecode -d 'Will also attempt to show if the system was booted by BIOS, UEFI, or UEFI [Le…'
complete -c inxi -s n -l network-advanced -d 'Show Advanced Network device information in addition to that produced by -N'
complete -c inxi -s N -l network -d 'Show Network device(s) information, including device driver'
complete -c inxi -s o -l unmounted -d 'Show unmounted partition information (includes UUID and LABEL if available)'
complete -c inxi -s p -l partitions-full -d 'Show full Partition information (-P plus all other detected mounted partition…'
complete -c inxi -l partitions -d 'Show basic Partition information'
complete -c inxi -l processes -s t
...
complete -c inxi -s s -l sensors -d 'Show output from sensors if sensors installed/configured: Motherboard/CPU/GPU…'
...
complete -c inxi -s x
complete -c inxi -s u -l uuid -d 'Show partition UUIDs.  Default: main partitions -P'
...
complete -c inxi -s W -o xx -o xxx -d 'Please note that your distribution\'s maintainer may chose to disable this fea…'
...
complete -c inxi -l pm-type -d 'For distro package maintainers only, and only for non apt, rpm, or pacman bas…'
...
complete -c inxi -o Ixxx -d 'of whitelisted programs'
